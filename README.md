...
This repository contains one of my end-to-end fine-tuning projects: adapting the LLM named *Qwen2.5-1.5B-Instruct* to better answer medical-style questions using a CPU-only LoRA approach.  
